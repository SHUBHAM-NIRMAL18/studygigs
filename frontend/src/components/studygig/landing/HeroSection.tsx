    ...
    <section className="relative overflow-hidden pt-16 pb-24 lg:pt-32 lg:pb-40">
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/5 border border-primary/20 text-primary text-sm font-medium animate-in fade-in slide-in-from-bottom-4 duration-700">
            <Zap className="h-4 w-4" />
            <span>The #1 Academic Task Marketplace</span>
          </div>

          {/* Headline */}
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight lg:leading-[1.1] animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100">
          ...
          {/* Subheadline */}
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto animate-in fade-in slide-in-from-bottom-12 duration-700 delay-200">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-in fade-in slide-in-from-bottom-16 duration-700 delay-300">
            <Button size="lg" className="h-14 px-8 text-lg rounded-full shadow-xl shadow-primary/30 hover:scale-105 transition-transform" onClick={onSignUpClick}>
              Post Your First Task <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
            <Button size="lg" variant="outline" className="h-14 px-8 text-lg rounded-full bg-background/50 backdrop-blur-sm hover:bg-background/80 transition-all">
              Browse Marketplace
            </Button>
          </div>
